...
def play_audio_start():
    start_audio = pygame.mixer.Sound("C:/Users/DENNIS/Desktop/Projects/python-beginner-projects/Exercise_Timer/beep_start.mp3")
    start_audio.play()
    pygame.time.wait(int(start_audio.get_length() * 1000))
    
def play_audio_stop():
   stop_audio = pygame.mixer.Sound("C:/Users/DENNIS/Desktop/Projects/python-beginner-projects/Exercise_Timer/beep_stop.mp3")
   stop_audio.play()
...
def exercise(time:int, interval:int, reps:int):
    for _ in range(reps):
        ...
        if reps != 0:
            ...
            print("Finished")
            finish_audio = pygame.mixer.Sound("C:/Users/DENNIS/Desktop/Projects/python-beginner-projects/Exercise_Timer/beep_finish.mp3")
            finish_audio.play()
